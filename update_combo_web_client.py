...
def updateComboWebClient():
    print ("updating combo web client...")
...
def setup_html_template(dname):
    ...
    filedata = filedata.replace('href="favicon.ico"', 'href="static/favicon.ico"')
    filedata = filedata.replace('src="', 'src="static/')
